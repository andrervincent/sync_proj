...
int main()
{
    ...
    if (
        (mutex[0] = sem_open("elephant", O_CREAT, 0644, 1)) == SEM_FAILED ||
    ...
    for (i=1; i<=N; i++) {
        ...
        case 1: /* Elephant code*/
                    ...
                    sem_wait(mutex[2]); // wait for Mouse
                    fflush(stdout);
        ...
        case 3: /*Cat Code*/
                    ...
                    sem_wait(mutex[1]); // wait for Dog
                    sem_wait(mutex[3]); // wait for Parrot
                    fflush(stdout);
        ...
        case 4: /*Mouse code*/
                    ...
                    sem_wait(mutex[0]); // wait for elephants and parrots
                    sem_wait(mutex[4]);
                    fflush(stdout);
        ...
        case 5: /*Parrot  Code*/
                    ...
                    sem_wait(mutex[1]); // wait for Cat
                    sem_wait(mutex[3]); // wait for Mouse
                    fflush(stdout);
